                    ...
                    <Grid item md={4}>
                      <Box className="planName visaServices">
                        ...
                        <Typography variant="body1">
                          ...
                          domestic helper in Hong Kong, even if you have found
                          someone outside of HelperDoc.
                        </Typography>
                        <Button className="arrowButton whitebtn">
                          Process / Renew Visa
                        </Button>
                ...
                <Grid md={3} className="applicantSidebar">
                      ...
                      <Link to="/">
                        <Box className="profileUpper">
                          <Box className="helperImg">
                            <img src="images/users/image_5.png" alt="userimg" />
                          </Box>
                  ...
                  <Box mt={3} className="helpder_details_dmc">
                    <Typography variant="h4">
                      <img src="./domesticlocation.svg" /> Domestic Helper Near
                      Me
                    </Typography>
                    <List>
                      <ListItem>
                  ...
                  <Box className="applicantDetails">
                    ...
                    <Box className="highlightsApplicant" mt={4}>
                      ...
                      <Typography variant="body1">
                        ...
                        discuss with potential applicants through direct
                        messages and set up an interview. Be as precise as
                        possible in your ad in order to get relevant
                        applications. You will then be able to further discuss
                        with potential applicants through direct messages and
                        set up an interview.
                      </Typography>
                      <Typography variant="h5">About Hiroshi Noruma</Typography>
                      <List>
                        <ListItem>
                          <b>Nationality</b>
                          <span>Filipino</span>
