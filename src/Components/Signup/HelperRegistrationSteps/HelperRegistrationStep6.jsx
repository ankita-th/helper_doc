...
const HelperRegistrationStep6 = ({
  ...
  const handleIntroVideoLinkChange = (
    event
  ) => {
            ...
            <Box className="uploadPhoto">
              ...
              <div className="UploadFileCustom queRow">
                <div className="inputFile">
                  ...
                  />
                  <Typography className="later">or upload photo later</Typography>
                </div>
              </div>
            </Box>
          </FormControl>
        ...
        <>
          <FormControl fullWidth className="queRow">
            ...
            <TextField className="formInputFiled"
              ...
              variant="outlined"
            />
            <Typography className="later">or upload video link later</Typography>
          </FormControl>
        </>
      ),
    },
