...
const HelperRegistrationStep2 = ({ formData, setFormData }) => {
                ...
                <FormGroup className="skillsCol">
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <CheckBoxField
                        field={field}
                        checkBoxesValues={["New Born", "Baby Sitting"]}
                      />
                    )}
                  />
                ...
                <FormGroup className="skillsCol">
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <CheckBoxField
                        field={field}
                        checkBoxesValues={["Indian Cooking", "Chinese Cooking"]}
                      />
                    )}
                  />
                  {/* <FormGroup className="radioCheckBtn">
                ...
                <FormGroup>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <CheckBoxField
                        field={field}
                        checkBoxesValues={["Gardening", "Driving"]}
                      />
                    )}
                  />
                  {/* <FormGroup className="radioCheckBtn">
              ...
              <div className="FileUploadtion">
                ...
                <div className="inputFile">
                  ...
                  <Input
                    type="file"
                    onChange={(e) =>
                      handleFileUpload(setFirstAidFile, e.target.files)
                    }
                  />
                </div>
              </div>
              ...
              <div className="FileUploadtion">
                ...
                <div className="inputFile">
                  ...
                  <Input
                    type="file"
                    onChange={(e) =>
                      handleFileUpload(setElderlyCaregivingFile, e.target.files)
                    }
                  />
                </div>
              </div>
              ...
              <div className="FileUploadtion">
                ...
                <div className="inputFile">
                  ...
                  <Input
                    type="file"
                    onChange={(e) =>
                      handleFileUpload(setNewBornCaregivingFile, e.target.files)
                    }
                  />
                </div>
              </div>
