            ...
            <Grid md={3} className='applicantSidebar Inner'>
                <Box>
                    ...
                    <Box className="applicantInfo">
                        ...
                        <Typography variant='body1'>Is Looking For Domestic Helper</Typography>
                        <List>
                            <ListItem><img src='./calendar.svg' alt='calendar'/><strong>Date of Need:</strong> 30/01/2024</ListItem>
                            <ListItem><img src='./hours.svg' alt='calendar'/><strong>Min. hours:</strong> 10 hrs</ListItem>
                        </List>
                    </Box>
                </Box>

                <Box mt={3} className='helpder_details_dmc'>
                    <Typography variant='h4'><img src="./domesticlocation.svg"/> Domestic Helper Near Me</Typography>
                    <List>
                        <ListItem>
                ...
                <Box>
                    <Button className='green-btn small' mt={1}>Edit Job</Button>
            ...
            <Grid md={9}>
                <Box className="applicantDetails">
                    ...
                    <Box className="highlightsApplicant" mt={4}>
                        ...
                        <Typography variant='body1'>Be as precise as possible in your ad in order to get relevant applications. You will then be able to further discuss with potential applicants through direct messages and set up an interview. Be as precise as possible in your ad in order to get relevant applications. You will then be able to further discuss with potential applicants through direct messages and set up an interview.</Typography>
                        <Typography variant='h5'>Job Details</Typography>
                        <List>
                            <ListItem><b>Start date </b><span>2024-01-30</span></ListItem>
                            <ListItem><b>Monthly salary</b><span>5000 SGD</span></ListItem>
                            <ListItem><b>Housing </b><span>Live in</span></ListItem>
                            <ListItem><b>Arrangement </b><span>Share with a kid</span></ListItem>
                            <ListItem><b>Day off on </b><span>Sunday</span></ListItem>
                            <ListItem><b>Flat size </b><span>900 square feets / square meters</span></ListItem>
                            <ListItem><b>Employer Nationality </b><span>Namibian</span></ListItem>
                        </List>
